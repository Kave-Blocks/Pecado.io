...
const Feature1 = () => {
  return (
    <div className="flex justify-center items-center min-h-screen mt-10 tablet:mt-[200px] px-4 tablet:px-0">
        <div className='mx-auto max-w-7xl flex justify-center items-center pt-2'>
        <div className="w-full flex flex-col gap-y-10">
            <DivFadeIn>
                <h2 className='text-[18px] tablet:text-[52px] text-primary-color font-bold tablet:w-[60%] font-Montserrat dark:text-white'>
            ...
            <div className="flex flex-col gap-y-5 tablet:flex-row justify-between items-center">
                    ...
                    <p className='text-[16px] tablet:text-[32px] tablet:w-[62%] font-Montserrat dark:text-white'>
