  ...
  return (
    <div className='min-h-screen flex flex-col justify-center items-center'>
        <div className="mx-auto max-w-7xl w-full flex flex-col">
            <DivFadeRight>
            <div className="flex flex-row justify-between items-center py-10 border-t-[1px] border-[#818181]">
                <h3 className='flex-[1] text-blue text-[48px] font-Montserrat font-bold dark:text-yellow-color'>Regulatory<br/> Compliance</h3>
                <p className='flex-[1] text-base md:w-[80%] dark:text-white'>
            ...
            <DivFadeLeft>
            <div className="flex flex-row justify-between items-center py-10 border-t-[1px] border-[#818181]">
                <h3 className='flex-[1] text-blue text-[48px] font-Montserrat font-bold dark:text-yellow-color'>Partners/<br/> Affiliates</h3>
                <p className='flex-[1] text-base md:w-[80%] dark:text-white'>
            ...
            <DivFadeRight>
            <div className="flex flex-row justify-between items-center py-10 border-t-[1px] border-[#818181]">
                <h3 className='flex-[1] text-blue text-[48px] font-Montserrat font-bold dark:text-yellow-color'>Leadership<br/> Team</h3>
                <p className='flex-[1] text-base md:w-[80%] dark:text-white'>
            ...
            <DivFadeLeft>
            <div className="flex flex-row justify-between items-center py-10 border-t-[1px] border-b-[1px] border-[#818181]">
                <h3 className='flex-[1] text-blue text-[48px] font-Montserrat font-bold dark:text-yellow-color'>Ledger<br/> Technology</h3>
                <p className='flex-[1] text-base md:w-[80%] dark:text-white'>
